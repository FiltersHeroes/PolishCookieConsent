...
var M = (function (exports) {
  ...
  class Utils {
    ...
    static checkWithinContainer(container, bounding, offset) {
      ...
      const containerBottom = container === document.body ? Math.max(containerRect.bottom, window.innerHeight) : containerRect.bottom;
  ...
  _defineProperty(Utils, "tabPressed", false);
  /** Specifies wether there is a key pressed. */
  _defineProperty(Utils, "keyDown", false);
  /**
   * Key maps.
   */
  _defineProperty(Utils, "keys", {
    TAB: ['Tab'],
    ENTER: ['Enter'],
    ESC: ['Escape', 'Esc'],
    BACKSPACE: ['Backspace'],
  ...
  class Dropdown extends Component {
    constructor(_el, options) {
      super(_el, options, Dropdown);
      /** ID of the dropdown element. */
      _defineProperty(this, "id", void 0);
      /** The DOM element of the dropdown. */
      _defineProperty(this, "dropdownEl", void 0);
      /** If the dropdown is open. */
      _defineProperty(this, "isOpen", void 0);
      /** If the dropdown content is scrollable. */
      _defineProperty(this, "isScrollable", void 0);
      _defineProperty(this, "isTouchMoving", void 0);
      /** The index of the item focused. */
      _defineProperty(this, "focusedIndex", void 0);
      _defineProperty(this, "filterQuery", void 0);
      ...
      _defineProperty(this, "_handleMouseLeave", e => {
      ...
      _defineProperty(this, "_handleDocumentClick", e => {
      ...
      _defineProperty(this, "_handleTriggerKeydown", e => {
      ...
      _defineProperty(this, "_handleDocumentTouchmove", e => {
        const target = e.target;
        if (target.closest('.dropdown-content')) {
          this.isTouchMoving = true;
        }
      });
      _defineProperty(this, "_handleDropdownClick", e => {
      ...
      _defineProperty(this, "_handleDropdownKeydown", e => {
        ...
        // ENTER selects choice on focused item
          ...
          const activatableElement = focusedElement === null || focusedElement === void 0 ? void 0 : focusedElement.querySelector('a, button');
      ...
      _defineProperty(this, "_handleWindowResize", () => {
      ...
      _defineProperty(this, "_resetFilterQuery", () => {
        this.filterQuery = [];
      });
      /**
       * Open dropdown.
       ...
       */
      _defineProperty(this, "recalculateDimensions", () => {
        if (this.isOpen) {
      ...
      this.id = Utils.getIdFromTrigger(_el);
    ...
    _setupEventHandlers() {
      var _this$dropdownEl;
      // Trigger keydown handler
      this.el.addEventListener('keydown', this._handleTriggerKeydown);
      // Item click handler
      (_this$dropdownEl = this.dropdownEl) === null || _this$dropdownEl === void 0 || _this$dropdownEl.addEventListener('click', this._handleDropdownClick);
    ...
    _placeDropdown() {
      ...
      if (getComputedStyle(closestOverflowParent).position === 'static') closestOverflowParent.style.position = 'relative';
  ...
  _defineProperty(Dropdown, "_dropdowns", []);
  ...
  class FormSelect extends Component {
    constructor(el, options) {
      var _this$el$tabIndex;
      super(el, options, FormSelect);
      /** If this is a multiple select. */
      _defineProperty(this, "isMultiple", void 0);
      /**
       * Label associated with the current select element.
       * Is "null", if not detected.
       */
      _defineProperty(this, "labelEl", void 0);
      /** Dropdown UL element. */
      _defineProperty(this, "dropdownOptions", void 0);
      ...
      _defineProperty(this, "selectOptions", void 0);
      _defineProperty(this, "_values", void 0);
      _defineProperty(this, "nativeTabIndex", void 0);
      _defineProperty(this, "_handleSelectChange", () => {
        this._setValueToInput();
      });
      _defineProperty(this, "_handleOptionClick", e => {
        e.preventDefault();
        const virtualOption = e.target.closest('li');
        this._selectOptionElement(virtualOption);
        e.stopPropagation();
      });
      _defineProperty(this, "_handleInputClick", () => {
      ...
      this.nativeTabIndex = (_this$el$tabIndex = this.el.tabIndex) !== null && _this$el$tabIndex !== void 0 ? _this$el$tabIndex : -1;
      this.el.tabIndex = -1;
      this._values = [];
      this._setupDropdown();
      this._setupEventHandlers();
    ...
    _selectOptionElement(virtualOption) {
      if (!virtualOption.classList.contains('disabled') && !virtualOption.classList.contains('optgroup')) {
        ...
        if (selectionHasChanged) this.el.dispatchEvent(new Event('change', {
          bubbles: true,
          cancelable: true,
          composed: true
        })); // trigger('change');
        ...
        dropdownOptions.onOpenEnd = () => {
          ...
          if (selectedOption) {
            ...
            if (this.dropdown.isScrollable) {
              let scrollOffset = selectedOption.getBoundingClientRect().top - this.dropdownOptions.getBoundingClientRect().top; // scroll to selected option
          ...
          if (userOnOpenEnd && typeof userOnOpenEnd === 'function') userOnOpenEnd.call(this.dropdown, this.el);
        };
        // Add callback for reseting "expanded" state
        dropdownOptions.onCloseEnd = () => {
          this.input.ariaExpanded = 'false';
          // Handle user declared onOpenEnd if needed
          if (userOnCloseEnd && typeof userOnCloseEnd === 'function') userOnCloseEnd.call(this.dropdown, this.el);
        };
    ...
    _createAndAppendOptionWithIcon(realOption, type) {
      ...
      const classes = (_realOption$getAttrib = realOption.getAttribute('class')) === null || _realOption$getAttrib === void 0 ? void 0 : _realOption$getAttrib.split(' ');
      if (iconUrl) {
    ...
    _toggleEntryFromArray(value) {
      if (this._isValueSelected(value)) this._deselectValue(value);else this._selectValue(value);
    }
    _getSelectedOptions() {
  ...
  class Sidenav extends Component {
    constructor(el, options) {
      ...
      _defineProperty(this, "lastWindowWidth", void 0);
      _defineProperty(this, "lastWindowHeight", void 0);
      _defineProperty(this, "_overlay", void 0);
      _defineProperty(this, "dragTarget", void 0);
      _defineProperty(this, "_startingXpos", void 0);
      _defineProperty(this, "_xPos", void 0);
      _defineProperty(this, "_time", void 0);
      _defineProperty(this, "_width", void 0);
      _defineProperty(this, "_initialScrollTop", void 0);
      _defineProperty(this, "_verticallyScrolling", void 0);
      _defineProperty(this, "deltaX", void 0);
      _defineProperty(this, "velocityX", void 0);
      _defineProperty(this, "percentOpen", void 0);
      _defineProperty(this, "_handleDragTargetDrag", e => {
        // Check if draggable
      ...
      _defineProperty(this, "_handleDragTargetRelease", () => {
        if (this.isDragged) {
      ...
      _defineProperty(this, "_handleCloseDrag", e => {
      ...
      _defineProperty(this, "_calculateDelta", e => {
      ...
      _defineProperty(this, "_handleCloseRelease", () => {
      ...
      _defineProperty(this, "_handleCloseTriggerClick", e => {
      ...
      _defineProperty(this, "_setAriaHidden", () => {
    ...
    _animateOverlayIn() {
      let start = 0;
      if (this.isDragged) start = this.percentOpen;else this._overlay.style.display = 'block';
      // Animation
      const duration = this.options.inDuration;
      // from
  ...
  _Sidenav = Sidenav;
  _defineProperty(Sidenav, "_sidenavs", void 0);
  _Sidenav._sidenavs = [];
  ...
  class Carousel extends Component {
    constructor(el, options) {
      ...
      _defineProperty(this, "hasMultipleSlides", void 0);
      _defineProperty(this, "showIndicators", void 0);
      _defineProperty(this, "noWrap", void 0);
      /** If the carousel is being clicked or tapped. */
      _defineProperty(this, "pressed", void 0);
      /** If the carousel is currently being dragged. */
      _defineProperty(this, "dragged", void 0);
      ...
      _defineProperty(this, "oneTimeCallback", void 0);
      _defineProperty(this, "_handleThrottledResize", () => Utils.throttle(this._handleResize, 200, null).bind(this));
      _defineProperty(this, "_handleCarouselTap", e => {
      ...
      _defineProperty(this, "_handleCarouselDrag", e => {
      ...
      _defineProperty(this, "_handleCarouselRelease", e => {
        if (this.pressed) {
          this.pressed = false;
        } else {
          return;
      ...
      _defineProperty(this, "_handleCarouselClick", e => {
      ...
      _defineProperty(this, "_handleIndicatorClick", e => {
        e.stopPropagation();
        this._handleIndicatorInteraction(e);
      });
      _defineProperty(this, "_handleIndicatorKeyPress", e => {
        e.stopPropagation();
        if (Utils.keys.ENTER.includes(e.key)) {
          this._handleIndicatorInteraction(e);
        }
      });
      _defineProperty(this, "_handleIndicatorInteraction", e => {
      ...
      _defineProperty(this, "_autoScroll", () => {
        let elapsed, delta;
        if (this.amplitude) {
      ...
      if (this.options.fullWidth) {
        ...
        if (this.showIndicators) {
          ...
          (_this$el$querySelecto = this.el.querySelector('.carousel-fixed-item')) === null || _this$el$querySelecto === void 0 || _this$el$querySelecto.classList.add('with-indicators');
        }
      }
    ...
    _setCarouselHeight(imageOnly = false) {
      const firstSlide = this.el.querySelector('.carousel-item.active') ? this.el.querySelector('.carousel-item.active') : this.el.querySelector('.carousel-item');
  ...
  class Tabs extends Component {
    constructor(el, options) {
      ...
      _defineProperty(this, "_tabLinks", void 0);
      _defineProperty(this, "_index", void 0);
      _defineProperty(this, "_indicator", void 0);
      _defineProperty(this, "_tabWidth", void 0);
      _defineProperty(this, "_tabsWidth", void 0);
      _defineProperty(this, "_tabsCarousel", void 0);
      _defineProperty(this, "_activeTabLink", void 0);
      ...
      _defineProperty(this, "_handleTabClick", e => {
    ...
    _animateIndicator(prevIndex) {
      ...
      if (isMovingLeftOrStaying) leftDelay = 90;else rightDelay = 90;
      // in v1: easeOutQuad
  ...
  class Forms {
    ...
    static textareaAutoResize(e) {
      ...
      if (!textarea.hasAttribute('original-height')) textarea.setAttribute('original-height', textarea.getBoundingClientRect().height.toString());
    ...
    static Init() {
      var _document;
      if (typeof document !== 'undefined') (_document = document) === null || _document === void 0 || _document.addEventListener('DOMContentLoaded', () => {
  ...
  function AutoInit(context = document.body, options) {
    var _options$FormSelect, _options$Sidenav, _options$Tabs;
    const registry = {
    ...
    FormSelect.init(registry.FormSelect, (_options$FormSelect = options === null || options === void 0 ? void 0 : options.FormSelect) !== null && _options$FormSelect !== void 0 ? _options$FormSelect : {});
    Sidenav.init(registry.Sidenav, (_options$Sidenav = options === null || options === void 0 ? void 0 : options.Sidenav) !== null && _options$Sidenav !== void 0 ? _options$Sidenav : {});
    Tabs.init(registry.Tabs, (_options$Tabs = options === null || options === void 0 ? void 0 : options.Tabs) !== null && _options$Tabs !== void 0 ? _options$Tabs : {});
  }
